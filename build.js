...
let executionPlan = [
  ...
  { expect: `${ROOT_PATH}>`, command: `powershell` },
  { expect: `PS ${ROOT_PATH}> `, command: `cd implementation` },
  { expect: `PS ${ROOT_PATH}\\implementation> `, command: `.\\build.ps1 -Build -BuildPrintouts -ExecuteScripts -TargetLayer hr`, successCheck: `Upgrade successful`, errorCheck: ['401 Unauthorized'] },
